...
desafio_dropdown = driver.find_element(By.XPATH, "//select[@class='form-control']")
opcoes_desafio = Select(desafio_dropdown)

sleep(1)

opcoes_desafio.select_by_index(2)
sleep(1)
opcoes_desafio.select_by_index(4)
sleep(1)
opcoes_desafio.select_by_index(6)
input('')
driver.quit()