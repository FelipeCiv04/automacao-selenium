...
sleep(2)
#
procurar_imagem = driver.find_element(By.XPATH, '//input[@id = "myFile"]')
sleep(2)
procurar_imagem.send_keys('C:\\imagens selenium\\pythonzinho.jpeg')
sleep(2)
#
upload = driver.find_element(By.XPATH, "//input[@value = 'Enviar Arquivo']")
upload.click()
input('')
